    ...
    <div className="bg-black text-white min-h-[calc(100vh-73px)] flex flex-col items-center justify-center text-center px-4 sm:px-6 md:px-8 relative overflow-hidden pb-0" ref={ref}>
      ...
      {mounted && (
        <div className="absolute inset-0 overflow-hidden hidden sm:block">
          {/* Main large star */}
          <div 
            className="absolute top-[15%] left-[65%] sm:left-[70%] transform transition-all duration-700"
            style={{ 
              transform: 'translateY(-50%)',
            }}
          >
            <span 
              className="text-[#30D5B6] text-[120px] md:text-[150px] cursor-pointer block opacity-40 hover:rotate-[360deg] transition-transform duration-700" 
              style={{ 
          ...
          <div className="absolute bottom-[25%] sm:bottom-[35%] left-[5%] sm:left-[10%]">
            <span 
          ...
          <div className="absolute top-[25%] sm:top-[30%] right-[15%] sm:right-[25%]">
            <span 
              className="text-[#30D5B6] text-xl opacity-30 cursor-pointer block hover:rotate-[360deg] transition-transform duration-500"
            >
              ✦
