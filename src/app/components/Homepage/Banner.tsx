...
const Banner: React.FC = () => {
  ...
  return (
    <div className="bg-black text-white min-h-screen flex flex-col items-center justify-center text-center px-4 sm:px-6 md:px-8 lg:px-16 pt-2 sm:pt-4 md:pt-6 pb-10 sm:pb-16 md:pb-20">
