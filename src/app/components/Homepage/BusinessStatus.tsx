        ...
        {Object.entries(businesses).map(([key, business]) => (
          <div key={key} className="space-y-4"> {/* Reduced space between elements */}
            <motion.div
              ...
              className="relative transform hover:-translate-y-1 transition-transform duration-300"
            >
              <h4 className={`
        ...
        <div className="fixed inset-0 flex items-center justify-center p-4">
          <Dialog.Panel className="w-full max-w-3xl">
            <motion.form 
              ...
              className={`w-full space-y-8 p-8 rounded-2xl shadow-xl
                ${theme === 'dark' 
            ...
            >
              ...
              <div className="flex gap-4">
                <motion.button
                  type="submit"
                  className="px-8 py-3 bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-xl hover:from-purple-700 hover:to-pink-700 transition-colors"
