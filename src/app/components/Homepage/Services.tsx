...
const ServiceLine: React.FC = () => {
  ...
  return (
    <div className="w-full pt-[100px] pb-16 px-6 bg-white overflow-hidden">
      <div className="flex flex-col items-center">
        ...
        <div className="w-full flex flex-col gap-6 mt-4">
          {[0, 1, 2].map((rowIndex) => (
            <div key={rowIndex} className={`flex ${rowIndex % 2 === 0 ? 'animate-marquee-right' : 'animate-marquee-left'}`}>
