...
const CareerHero = () => {
  return (
    <section className="relative bg-white pt-4"> {/* Changed mt-24 to pt-24 */}
      <div className="container mx-auto px-4 md:px-[122px] py-16 md:py-24">
        <div className="text-start pb-12"> {/* Changed mb-12 to pb-12 */}
          <h1 className="text-black text-3xl sm:text-4xl md:text-5xl lg:text-6xl 2xl:text-[50px] font-bold pb-6 leading-tight"> {/* Changed mb-6 to pb-6 */}
